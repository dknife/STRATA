...
\subsection{Facebook 전체 비교 (12 methods)}

\begin{table}[H]\centering
\caption{Facebook ($n\!=\!4{,}039$): 전체 12종 순위}
\label{tab:fb-all}
\small
...
\midrule
\rowcolor{newbest!15} 1 & BG1 & GPU-PerSrc-BFS & \textbf{0.016} & 122$\times$ & 880$\times$ \\
\rowcolor{newbest!10} 2 & BG2 & DAWN-SOVM & 0.019 & 101$\times$ & 741$\times$ \\
\rowcolor{gpucol!8} 3 & TG2 & D-STORM-CUDA & 0.028 & 68$\times$ & 503$\times$ \\
4 & TG1 & D-STORM-DAWNiBFS & 0.247 & 7.8$\times$ & 57$\times$ \\
\rowcolor{cpubest!5} 5 & TC1 & D-STORM-SpMM-Cython & 0.984 & 2.0$\times$ & 14$\times$ \\
6 & TC2 & D-STORM-NumpyBLAS & 1.697 & 1.1$\times$ & 8$\times$ \\
7 & TC3 & D-STORM-GraphBLAS & 1.921 & 1.0$\times$ & 7$\times$ \\
8 & BC2 & SciPy & 1.918 & 1.0$\times$ & 7$\times$ \\
9 & BC4 & M-AORM & 2.831 & 0.7$\times$ & 5$\times$ \\
10 & BC5 & GB-bfs & 4.071 & 0.5$\times$ & 3$\times$ \\
11 & BC3 & I-AORM & 8.693 & 0.2$\times$ & 2$\times$ \\
12 & BC1 & NetworkX & 14.073 & 0.1$\times$ & 1$\times$ \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{tikzpicture}
\begin{axis}[
  xbar, width=0.88\textwidth, height=9.5cm, bar width=7pt,
  xlabel={실행 시간 (초)},
  symbolic y coords={BG1,BG2,TG2,TG1,TC1,TC2,TC3,BC2,BC4,BC5,BC3,BC1},
  ytick=data,
...
\rowcolor{cpubest!5} 5 & TC1 & D-STORM-SpMM-Cython & 2.293 & 0.382 \\
6 & BC2 & SciPy & 3.305 & 0.551 \\
7 & TC3 & D-STORM-GraphBLAS & 4.429 & 0.738 \\
8 & TC2 & D-STORM-NumpyBLAS & 6.726 & 1.121 \\
9 & BC4 & M-AORM & 10.102 & 1.684 \\
10 & BC5 & GB-bfs & 12.428 & 2.071 \\
11 & BC3 & I-AORM & 14.885 & 2.481 \\
12 & BC1 & NetworkX & 20.054 & 3.342 \\
\bottomrule
\end{tabular}
\end{table}
