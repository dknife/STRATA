...
This file provides guidance to Summarize the findings in this project and research
...
The followings are major interest of this research note

1. STRATA definition
- Basic Idea of AORM and its limitations
- Improvement of STRATA from AORM base

2. Definitions of Problems: 1) APSP 2) Dynamic Edge Insertion and Deletion 3) Betweenness Centrality Computation
- Currently known approaches to APSP and its applications
- Currently known approaches to Dynamic Edge Insertion and Deletion and its applications
- Currently known approaches to Betweenness Centrality Computation and its applications

3 How STRATA works and what is known baseline techniques in APSP problem
- Implementation details for fast STRATA
- What is the advantages of STRATA over other methods

4 Dynamic Edge Insertion and Deletion Problem definition
- What is the contribution of our methods for this problem?
- What did we propose to solve this problem
- Contribution of proposed method

5. How can we solve the betweenness centrality problem with STRATA or our genuine methods
- What is the contribution of our methods for this problem?
- What did we propose to solve this problem
- Contribution of proposed method
